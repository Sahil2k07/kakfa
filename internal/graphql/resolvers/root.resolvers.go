...
// Version is the resolver for the _version field.
func (r *mutationResolver) Version(ctx context.Context) (*string, error) {
	panic(fmt.Errorf("not implemented: Version - _version"))
}
...
/*
	func (r *mutationResolver) _(ctx context.Context) (*string, error) {
